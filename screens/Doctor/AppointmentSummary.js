    ...
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        <KeyboardAvoidingView enabled>
          ...
          <View style={{ flexDirection: "row" }}>
            <View style={styles.SectionStyle}>
              <Text style={styles.left1}>Date:</Text>
              <Text style={styles.left2}>{date.substr(1, 10)}</Text>
            </View>
            <View style={styles.SectionStyle1}>
              <Text style={styles.right1}>Time:</Text>
              <Text style={[styles.right2]}>{Timeslot}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row" }}>
            <View style={styles.SectionStyle}>
              <Text style={styles.left1}>Hospital:</Text>
              <Text style={styles.left2}>{DataHospital}</Text>
            </View>
            <View style={styles.SectionStyle1}>
              <Text style={[styles.right1]}>Category:</Text>
              <Text style={[styles.right2]}>{DataCate}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row" }}>
            <View style={styles.SectionStyle}>
            ...
            <View style={styles.SectionStyle1}>
              <Text style={[styles.right1]}>Room no:</Text>
              <Text style={[styles.right2]}>A109</Text>
            </View>
          </View>
          ...
          >
            <Text style={styles.buttonTextStyle}>Send Appointment Request</Text>
          </TouchableOpacity>
        </KeyboardAvoidingView>
      </View>
    </View>
